...
function App(){
  ...
  useEffect(()=>{ if(user && selectedPropertyId) (groups[tab]||[]).forEach(r=>dispatch(loadResource(r))); },[tab,dispatch,user,selectedPropertyId]);
