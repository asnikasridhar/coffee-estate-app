...
function PlantInventoryHierarchyScreen({user,propertyId,data,request,reload,t}){
  ...
  const blank=()=>({crop_id:'',crop_type_id:'',variety_master_id:'',block_id:'',sub_block_name:'',plant_count:'0',planting_date:isoDate(),spacing:'',status:'active',notes:''});
